  ...
  Future<bool> obtenerAfiliadosDni(String dni) async {
    ...
    try {
      ...
      if (decodedData.length > 0) {
        ...
        prefs.idTipoPersonaDtipoPersona =
            decodedData[0]['id_tipo_de_persona_dtipo_de_persona'].toString();
        prefs.idFacultadDfacultad =
            decodedData[0]['id_facultad_dfacultad'].toString();
        ...
        prefs.idPersonaDpersona =
            decodedData[0]['id_persona_dpersona'].toString();

...
class AfiliadosDatabase{
  ...
  insertarAfiliados(AfiliadosModel afiliados)async{
    try{
      ...
      final res = await db.rawInsert(
          ...
          "fechaAfiliacion,fechaCesantia,nveces,fechaDesafiliacion) "
              ...
              "'${afiliados.nveces}','${afiliados.fechaDesafiliacion}')");
      return res;
  ...
  Future<List<AfiliadosModel>> cargarAfiliados() async {
    final db = await dbprovider.database; 
    final res =
    await db.rawQuery("SELECT * FROM Afiliados" );
  ...
  Future<List<AfiliadosModel>> cargarAfiliadoPorDni(String dni) async {
    final db = await dbprovider.database; 
    final res =
    await db.rawQuery("SELECT * FROM Afiliados where dni='$dni'" );
  ...
  Future<List<AfiliadosModel>> consultarPersonaPorQuery(String query) async {
    ...
    final res = await db.rawQuery(
        "SELECT * FROM Afiliados WHERE nombrePersona LIKE '%$query%'");
